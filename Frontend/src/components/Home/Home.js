...
import { List, ListItem, Select, Hidden, MenuItem } from "@material-ui/core";
// import component
...
const Home = (props) => {
  ...
  useEffect(() => {
    async function fetchdata() {
      ...
      setPreimg(
        `${config.API_URL}/images/currency/${precurrency?.data[0]?.image}`
      );
  ...
  const handleviewoffer = async () => {
    ...
    if (coin == prefferedcurrency) {
      data.preferedcurrency =
        "cryptocurrency and prefered currency must be differ";
    }
    if (isEmpty(data)) {
      setLoading(true);
      var payload = {
      ...
      if (res.data.type == "success") {
        setLoading(false);
        navigate.push(`/viewoffers/${ordertype}/${coin}`, {
          state: res?.data?.data,
        });
      } else {
            ...
            <div className="row jc-center text-center">
              <div className="col-lg-6">
                <div className="banner_ad_wrapper">
                  <div>
                    <Select value={selLang} onChange={handleLanguage}>
                      <MenuItem value="EN">ENGLISH</MenuItem>
                      <MenuItem value="FR">FRENCH</MenuItem>
                    </Select>

                    <h1 className="blackandwhite">Welcome to Krinos P2P</h1>
                    <p className="roboto subhead">
                      Anonymous P2P deals on your teams. Trade globaly using for
                      any payment system for any currency.{" "}
                    </p>
                    {/* <button className='mt-3 borderbtn'><i class="fa fa-video-camera" aria-hidden="true"></i> Learn To Trade</button> */}
                    <Link
                      to="/details/demo_videos"
                      className="navlink_pos_zin borderbtn mt-3 d-block"
                    >
                    ...
                    <Tab eventKey="Buy" title="BUY" className="px-3 py-3">
                      <div className="row mt-3">
                          ...
                          <div className="themeselect mb-3 themeselct_home_se">
                            ...
                            <Dropdown className="headerdropdown m-left iner_drop_versiotwo">
                              <Dropdown.Toggle
                                ...
                                id="dropdown-basic"
                              >
                                <img src={coinimg} className="iconss" />
                                <span>{coin}</span>
                              </Dropdown.Toggle>
                                    ...
                                    <Dropdown.Item>
                                      <p
                                        onClick={() => {
                                          setCoin(data?.coin);
                                          setCoinimg(
                                            `${config?.API_URL}/images/currency/${data?.image}`
                                          );
                                        }}
                                      >
                                        <img
                        ...
                        <div className="col-md-6">
                          <div className="themeselect themeselct_home_se mb-3 p-0">
                            ...
                            <Dropdown className="headerdropdown m-left iner_drop_versiotwo">
                              <Dropdown.Toggle
                                ...
                                id="dropdown-basic"
                              >
                                <img src={preimage} className="iconss" />
                                <span>{prefferedcurrency}</span>
                              </Dropdown.Toggle>
                          ...
                          <p className="text-danger error-message mb-3">
                            {" "}
              ...
              <div className="row borderbox_img_wi">
                <div className="col-12 col-md-4">
                  <div className="borderbox">
                    ...
                    <p>
                      Bitcoins are held in safe escrow until the transaction is
                      fully concluded
                    </p>
                ...
                <div className="col-12 col-md-4">
                  <div className="borderbox">
                    ...
                    <p>
                      ...
                      <Link to="/register">Sign up for Krinos P2P</Link>
                    </p>
                ...
                <div className="col-12 col-md-4">
                  <div className="borderbox">
                    ...
                    <p>
                      Krinos P2P's feedback system highlights reliable and
                      experienced users, helping you trade smoothly
                    </p>
                      ...
                      <>
                        <div class="card">
                          ...
                          >
                            ...
                            >
                              <h5 class="mb-0 d-flex jc-between">
                                {data?.question}
