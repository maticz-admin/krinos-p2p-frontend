export default {
    ...
    "EXPLORE_MARKETS_DESCRIPTION_2": "Trade Bitcoin, ETH, and hundreds of other Krinos P2P Currencies in minutes.",
    "BUY": "Buy",
    "DASHBOARD": "Dashboard",
    "MARKET": "Market",
    "SPOT_ORDERS":"Orders",
    ...
    "OFFER" : "Offer",
    "BUY_OR_SELL_BITCOIN" : "Buy or Sell Bitcoin from other users using any payment",
    ...
    "SELL_BITCOIN_WITH_COMPANY":"Sell Bitcoin With Company",
    "BUY_BITCOIN_PAYMENT_CURRENCY":"Buy Bitcoin from other users using any payment",
    ...
    "BITCOIN_WITH_COMPANY":"Bitcoin With Company",
    "BITCOIN_ROM_OTHER_USERS_USING_ANY_PAYMENT":"Bitcoin from other users using any payment",
    "I_WILL":"I will",
    "ENTER_AMOUNT_TO_GET_STARTED":"Enter amount to get started",
    ...
    "SERVICE":"Service",
    "BUY_SELL_BITCOIN_FROM":"Buy/Sell Bitcoin from other users using any payment method and currency",
    "PAYMENT_METHOD":"Payment method",
    ...
    "CHOOSE_BITCOIN_RATE":"Choose Bitcoin rate you want to use",
    "YOUR_CAN_SET_ONLY_FIXED_PRICE":"Your can set only Fixed Price",
    "YOUR_OFFER_SELLING_PRICE":"Your offer’s selling price will change according to the market price of Bitcoin.",
